...
def _mech_opts_lst(exp_set, gases, kwarg_dct):
    """ Creates a list of mech_opts, one for each mechanism
        ...
        vary some parameter in different ways for different sets. However,
        options can still be used for multiple sets (e.g., mech_names for
        simulating multiple sets)
